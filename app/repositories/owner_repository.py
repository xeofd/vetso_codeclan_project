...
def save(owner):
    ...
    sql = "INSERT INTO onwer (first_name, last_name, email_address, contact_number, address, post_code, city, registered) VALUE (%s, %s, %s, %s, %s, %s, %s, %s) RETURN id"
    values = [owner.first_name, owner.second_name, owner.email_address, owner.contact_number, owner.address, owner.post_code, owner.city, owner.registered]
